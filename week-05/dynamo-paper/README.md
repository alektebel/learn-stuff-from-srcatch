...
- [`system-design/`](../../week-06/system-design/) — consistent hashing, caching and reliability
  patterns in isolation
- [`context-caching/`](../../week-08/context-caching/) — the same "make the expensive thing cheap"
