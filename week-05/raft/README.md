...
6. **Wire it under [`database-engine/`](../../week-04/database-engine/)**: a replicated
...
- [`dynamo-paper/`](../dynamo-paper/) — the same partition, the opposite answer.
  Read them as a pair.
- [`database-engine/`](../../week-04/database-engine/) — the log this would replicate
- [`system-design/`](../../week-06/system-design/) — where consensus sits among the other
  patterns
- [`aws-from-scratch/`](../../week-06/aws-from-scratch/) — DynamoDB's quorums, and what
  they cost
