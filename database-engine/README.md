...
The repo already had replication ([`dynamo-paper/`](../week-04/dynamo-paper/)) and
capacity ([`aws-from-scratch/`](../week-05/aws-from-scratch/)) — both *above* a storage
...
It also has a parser you already wrote ([`c-compiler/`](../week-03/c-compiler/)) and no
...
a lexer, which
[`../compiler-and-vgpu/frontend.py`](../week-03/compiler-and-vgpu/frontend.py) shipped
with and had to fix.
...
7. **Wire it to [`../dynamo-paper/`](../week-04/dynamo-paper/)**: this engine as the
...
- [`dynamo-paper/`](../week-04/dynamo-paper/) — replication above a storage engine;
  this is the engine it replaced with a dict
- [`aws-from-scratch/`](../week-05/aws-from-scratch/) — DynamoDB's partitioning and
  capacity model, and what all of this costs
- [`c-compiler/`](../week-03/c-compiler/) — the same parsing problem, for a language
  with more of a type system
- [`system-design/`](../week-05/system-design/) — the patterns a database sits under
