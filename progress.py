...
PLAN = [
    ...
    ("autograd",                 30,  2, "FCS"),
    ("llm-from-scratch",         55,  3, "FCS"),
    ("context-caching",          28,  4, "FCS"),
    ("inference-from-scratch",   60,  6, "FC"),
    ("deploy-and-debug",         10,  6, "FCS"),
    ("provenance-semirings",     45,  7, "FC"),
    ("scasp",                    45,  8, "FC"),
    ("linc",                     30,  9, "FC"),
    ("contextcite",              13, 10, "FC"),
    ("spade",                    16, 10, "FC"),
    ("mars-sql",                 20, 10, "FC"),
    ("distributed-training",     10, 11, "FC"),
    ("database-engine",          50, 12, "FCS"),
    ("dynamo-paper",             21, 13, "FCS"),
    ("raft",                     30, 13, "FC"),
    ("bash-from-scratch",         8, 14, "FCS"),
    ("http-server",              86, 15, "FCS"),
    ("dns-server",                9, 15, "F"),
    ("cryptographic-library",     5, 15, "F"),
    ("communication-protocols",  34, 15, "F"),
    ("toralizer",                21, 16, "F"),
    ("firewall-from-scratch",    25, 16, "F"),
    ("c-compiler",               27, 16, "FCS"),
    ("compiler-and-vgpu",        16, 16, "FCS"),
    ("quantum-computing-lang",    8, 16, "F"),
    ("haskell-projects",         61, 17, "F"),
    ("system-design",            48, 17, "F"),
    ("cuda-from-scratch",       122, 17, "FCS"),
    ("ml-inference",            137, 17, "FC"),
    ("ray-tracer",               35, 17, "F"),
    ("tensorrt-inference",      109, 18, "F"),
    ("vllm-engine",             156, 18, "FC"),
    ("world-models",            106, 18, "F"),
...
BASELINE = {
    ...
    "ml-inference": 6, "mlops": 13, "provenance-semirings": 76,
    "quantum-computing-lang": 17, "raft": 30, "ray-tracer": 41,
