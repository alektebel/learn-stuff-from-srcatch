...
- **Pure Python, single-threaded, CPU.** A matmul is three nested loops. Real
  ...
  [`../cuda-from-scratch/`](../week-07/cuda-from-scratch/) for the other end of that.
...
- [`llm-from-scratch/`](../llm-from-scratch/) — a transformer trained on this
  engine
- [`cuda-from-scratch/`](../week-07/cuda-from-scratch/) — the same matmul, on a GPU,
  1000x faster
- [`world-models/`](../week-15/world-models/), [`diffusion-models/`](../week-16/diffusion-models/)
  — where `import torch` stops being a black box
- [`ml-inference/`](../week-09/ml-inference/) — what happens to a trained model next
