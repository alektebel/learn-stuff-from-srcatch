...
| ElastiCache | A cache; see [`system-design/`](../../week-06/system-design/) | — |
| EFS, FSx | A filesystem, so *not* S3's flat model | `s3.py` (by contrast) |
| CloudFront | A CDN; edge caching and invalidation | [`context-caching/`](../../week-08/context-caching/) |
...
| CloudWatch, X-Ray | Metrics, alarms, budgets, tracing | [`deploy-and-debug/`](../../week-08/deploy-and-debug/) |
...
| SageMaker, Bedrock | Model serving | [`context-caching/`](../../week-08/context-caching/) |
...
- [`dynamo-paper/`](../../week-05/dynamo-paper/) — the 2007 paper DynamoDB is built on
- [`deploy-and-debug/`](../../week-08/deploy-and-debug/) — operating and debugging this kind of system
- [`system-design/`](../../week-06/system-design/) — the patterns underneath most of these services
