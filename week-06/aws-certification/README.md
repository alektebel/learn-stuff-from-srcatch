...
- [`aws-from-scratch/`](../aws-from-scratch/) — the eight mechanisms, and the bill
- [`system-design/`](../system-design/) — the patterns underneath most services
- [`deploy-and-debug/`](../../week-08/deploy-and-debug/) — operating what you chose
- [`dynamo-paper/`](../../week-05/dynamo-paper/) — why DynamoDB is shaped that way
