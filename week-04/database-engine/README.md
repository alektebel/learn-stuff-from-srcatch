...
The repo already had replication ([`dynamo-paper/`](../../week-05/dynamo-paper/)) and
capacity ([`aws-from-scratch/`](../../week-06/aws-from-scratch/)) — both *above* a storage
...
7. **Wire it to [`dynamo-paper/`](../../week-05/dynamo-paper/)**: this engine as the
...
- [`dynamo-paper/`](../../week-05/dynamo-paper/) — replication above a storage engine;
  this is the engine it replaced with a dict
- [`aws-from-scratch/`](../../week-06/aws-from-scratch/) — DynamoDB's partitioning and
...
- [`system-design/`](../../week-06/system-design/) — the patterns a database sits under
