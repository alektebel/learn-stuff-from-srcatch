...
[`dynamo-paper/`](../week-04/dynamo-paper/) deliberately refuses consensus. Its own
...
6. **Wire it under [`../database-engine/`](../database-engine/)**: a replicated
...
- [`dynamo-paper/`](../week-04/dynamo-paper/) — the same partition, the opposite answer.
  Read them as a pair.
- [`database-engine/`](../database-engine/) — the log this would replicate
- [`system-design/`](../week-05/system-design/) — where consensus sits among the other
  patterns
- [`aws-from-scratch/`](../week-05/aws-from-scratch/) — DynamoDB's quorums, and what
  they cost
