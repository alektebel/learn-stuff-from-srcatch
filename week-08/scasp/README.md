...
This directory is the engine. [`../provenance-semirings/`](../provenance-semirings/)
is the algebra you will eventually hang off the tree. [`../linc/`](../linc/)
...
Do [`../provenance-semirings/`](../provenance-semirings/) first if you
