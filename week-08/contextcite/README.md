...
- [`context-caching/`](../../week-08/context-caching/) — a different "context" problem: making
  inference cheap rather than explaining it
- [`dynamo-paper/`](../../week-05/dynamo-paper/) — another paper replicated section by section
