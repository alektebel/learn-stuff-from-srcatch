...
- [`dynamo-paper/`](../../week-05/dynamo-paper/) — the store this one operates
- [`context-caching/`](../../week-08/context-caching/) — the serving mechanisms this one sizes
- [`system-design/`](../../week-06/system-design/) — circuit breakers, backpressure, rate limiting
