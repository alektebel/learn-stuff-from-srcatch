...
- [`cuda-from-scratch/`](../../week-09/cuda-from-scratch/) — real CUDA, once you know what a warp is
- [`context-caching/`](../../week-08/context-caching/) — where GPU memory actually goes in practice
