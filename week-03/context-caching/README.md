...
6. **A distributed prefix cache.** Combine this with [`week-10/dynamo-paper/`](../../week-10/dynamo-paper/):
...
- [`vllm-engine/`](../../reference/vllm-engine/) — PagedAttention and continuous batching at scale
- [`llm-from-scratch/`](../../week-02/llm-from-scratch/) — the attention this cache is a cache OF
- [`ml-inference/`](../../reference/ml-inference/) — quantisation and inference optimisation generally
- [`dynamo-paper/`](../../week-10/dynamo-paper/) — the same "make the expensive thing cheap"
